...
ActiveRecord::Schema.define(version: 20200903154342) do
  ...
  create_table "wallpostcomments", force: :cascade do |t|
    t.text "content"
    t.string "commenter"
    t.bigint "wallpost_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["wallpost_id"], name: "index_wallpostcomments_on_wallpost_id"
  end
